...
namespace GameTools {
    public static class GT {
        ...
        public static string ReadASCII(GTFS fs, long offset, int length, bool flip) {
        ...
        public static int ReadInt16(GTFS fs, int length, bool flip) {
        ...
        public static int ReadInt32(FileStream fs, int length, bool flip) {
        ...
        public static uint ReadUInt32(GTFS fs, int length, bool flip) {
            byte[] bytes = ReadBytes(fs, length, flip);
